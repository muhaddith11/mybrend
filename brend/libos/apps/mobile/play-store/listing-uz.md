# Play Store — do'kon sahifasi matni (o'zbek tilida)

Quyidagi matnlarni Play Console > Store presence > Main store listing bo'limiga
copy-paste qiling.

## Short description (max 80 belgi)

```
Qo'qondagi kiyim do'konlari — bitta ilovada. Xarid qiling, yetkazib bering!
```

## Full description (max 4000 belgi)
...
Savol yoki takliflaringiz bo'lsa, biz bilan bog'laning: [email/telegram qo'shing]
...
- **App name**: ZYFF
- **Category**: Shopping
- **Contact email**: (to'ldirilishi kerak — support email)
- **Website**: https://zyff.uz
