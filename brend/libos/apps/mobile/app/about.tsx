...
export default function AboutScreen() {
  ...
  const blocks: { t: string; b: string }[] =
    lang === 'ru'
      ? [
          { t: 'Наши магазины', b: 'На платформе представлены Asma Design (премиальная мужская одежда), Boosner (100% оригинальные бренды — Adidas, Calvin Klein, New Balance), One Pro Boutique (современная мужская одежда) и Aura Med Forma (профессиональная одежда для медицинских работников). У каждого магазина своя страница, товары и служба доставки.' },
      ...
      : lang === 'en'
      ? [
          { t: 'Our stores', b: 'The platform features Asma Design (premium menswear), Boosner (100% original brands — Adidas, Calvin Klein, New Balance), One Pro Boutique (modern menswear) and Aura Med Forma (professional medical workwear). Each store has its own page, products and delivery service.' },
      ...
      : [
          { t: "Bizning do'konlarimiz", b: "Platformamizda Asma Design (premium erkaklar kiyimi), Boosner (100% original brendlar — Adidas, Calvin Klein, New Balance), One Pro Boutique (zamonaviy erkaklar kiyimi) va Aura Med Forma (tibbiyot xodimlari uchun professional kiyim) kabi do'konlar mavjud. Har bir do'kon o'z sahifasiga, mahsulotlariga va yetkazib berish xizmatiga ega." },
