...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  item: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: c.surface2, padding: 16, borderRadius: 10, marginBottom: 8, borderWidth: 0.5, borderColor: c.border },
  itemText: { flex: 1, fontSize: 14, color: c.text },
})
