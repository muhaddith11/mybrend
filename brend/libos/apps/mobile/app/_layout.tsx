...
export default function RootLayout() {
  ...
  // ilova dizayniga mos emas — ingichka, shaffof, mavzuga mos (tungi: oq, light: navy)
  ...
  useEffect(() => {
    if (Platform.OS === 'web' && typeof document !== 'undefined') {
      ...
      const thumb = dark ? 'rgba(255,255,255,0.22)' : 'rgba(27,31,75,0.22)'
      const thumbHover = dark ? 'rgba(255,255,255,0.38)' : 'rgba(27,31,75,0.38)'
      style.textContent = `
