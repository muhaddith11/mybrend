...
// Shahar tanlash ro'yxati. `key` — backend `Store.city` ustuni bilan bir xil
// yozilishi kerak (filter shu qiymat bo'yicha ishlaydi, case-insensitive).
// Hozircha faqat Qo'qonda do'konlar bor — qolganlari "tez orada".
