...
const shopLinks = [
  ...
  { href: `${BASE}/collection?category=onp-koylak`, label: "Ko'ylaklar" },
  { href: `${BASE}/collection?category=onp-futbolka`, label: 'Futbolkalar' },
  { href: `${BASE}/collection?category=onp-shim`, label: 'Shimlar' },
  { href: `${BASE}/collection?category=onp-aksessuar`, label: 'Aksessuarlar' },
]
const companyLinks = [
    ...
    <footer className="bg-foreground text-background mt-12">
      <div className="container mx-auto px-4 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <span className="text-2xl font-extrabold tracking-tight">ONEPRO</span>
            <p className="text-sm text-background/60 mt-4 leading-relaxed">
              Erkaklar uchun zamonaviy va sifatli kiyimlar butigi. Ko&apos;ylaklar, shimlar, ustki kiyim va aksessuarlar.
            </p>
          </div>
      ...
      <div className="border-t border-background/10">
        <div className="container mx-auto px-4 lg:px-8 py-5 text-center text-xs text-background/50">
          &copy; {new Date().getFullYear()} One Pro. Barcha huquqlar himoyalangan.
        </div>
      </div>
    </footer>
  )
