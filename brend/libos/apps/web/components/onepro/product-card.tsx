...
import { Product, useStore, formatPrice, colorMap } from '@/lib/onepro/store'
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] bg-muted overflow-hidden mb-2 lg:mb-4">
        ...
        <Link href={`/store/onepro/product/${product.id}`} className="absolute inset-0" aria-label={product.nameUz}>
          <Image
        ...
        {/* Product Info */}
        <Link href={`/store/onepro/product/${product.id}`} className="block space-y-2">
