...
import { Product, categories } from '@/lib/onepro/store'
import { createProduct, updateProduct } from '@/lib/onepro/products'
import { uploadProductImage } from '@/lib/onepro/upload'
...
export function ProductForm({ initialData, mode }: ProductFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/store/onepro/admin/products')
    } catch (e) {
      console.error(e)
      setSaving(false)
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 lg:p-8 max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        <Link
          href="/store/onepro/admin/products"
