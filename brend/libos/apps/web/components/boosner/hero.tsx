    ...
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl lg:text-8xl font-sans font-extrabold tracking-tight text-foreground mb-6 text-balance uppercase"
        >
          Original
          <br />
          <span className="text-primary">Brendlar</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-md text-white/80 text-sm sm:text-base leading-relaxed mb-10"
        >
          Adidas, Calvin Klein, New Balance va boshqa brendlar — eng yaxshi narxlarda, kafolat bilan.
        </motion.p>
        ...
        >
          ...
          >
            <Link href="/store/boosner/collection">Kolleksiyani Ko&apos;rish</Link>
          </Button>
          <Button
            asChild
            variant="outline"
          ...
          >
            <Link href="/store/boosner/lookbook" className="flex items-center gap-2">
