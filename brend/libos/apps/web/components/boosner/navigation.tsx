...
export function Navigation() {
  ...
  const isHomePage = pathname === '/store/boosner'
        ...
        <nav className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-20 gap-4">
            ...
            <div className="flex items-center gap-1 lg:gap-0">
              ...
              <Link href="/store/boosner" className="flex items-center group">
                {logo ? (
                  <img src={logo} alt="BOOSNER" className="h-10 lg:h-12 w-auto object-contain" />
                ) : (
