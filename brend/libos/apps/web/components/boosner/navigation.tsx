...
const categories = [
  ...
  { label: 'Krossovkalar', href: `${BASE}/collection?category=bsn-krossovka` },
  { label: 'Futbolkalar', href: `${BASE}/collection?category=bsn-futbolka` },
  { label: 'Kurtkalar', href: `${BASE}/collection?category=bsn-kurtka` },
  { label: 'Aksessuarlar', href: `${BASE}/collection?category=bsn-aksessuar` },
  { label: 'Brendlar', href: `${BASE}/collection` },
]
        ...
        <div className="h-16 lg:h-20 flex items-center gap-3 lg:gap-6">
          ...
          <Link href={BASE} className="shrink-0">
            {logo ? (
              ...
              <span className="text-2xl lg:text-3xl font-extrabold tracking-tight text-foreground">BOOSNER</span>
            )}
          </Link>
