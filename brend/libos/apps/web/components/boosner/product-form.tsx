...
import { Product, categories } from '@/lib/boosner/store'
import { createProduct, updateProduct } from '@/lib/boosner/products'
import { uploadProductImage } from '@/lib/boosner/upload'
...
export function ProductForm({ initialData, mode }: ProductFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/store/boosner/admin/products')
    } catch (e) {
      console.error(e)
      setSaving(false)
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 lg:p-8 max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        <Link
          href="/store/boosner/admin/products"
