...
interface BrandStorySectionProps {
  /** Do'kon slug'i — rasm yo'li va "batafsil" havolasi uchun. */
  slug: string
  /** Brend ko'rinadigan nomi (alt va tavsifda ishlatiladi), masalan "Asma Design". */
  brandName: string
  /** Brendning UI tugmasi. */
  Button: ElementType
}

export function BrandStorySection({ slug, brandName, Button }: BrandStorySectionProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="absolute inset-0 bg-muted overflow-hidden">
              <Image
                src={`/${slug}/hero-poster.jpg`}
                alt={`${brandName} Atelier`}
                fill
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                {brandName} - bu Qo&apos;qon shahrida 2024-yilda tashkil etilgan premium erkaklar
            ...
            >
              <Link href={`/store/${slug}/about`} className="inline-flex items-center gap-2">
                Batafsil o&apos;qish
