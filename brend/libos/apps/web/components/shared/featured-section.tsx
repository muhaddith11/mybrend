...
interface FeaturedSectionProps {
  /** Do'kon slug'i — "barcha mahsulotlar" havolasi uchun. */
  slug: string
  /** Shu do'konning mahsulotlarini olib keluvchi (brendga bog'langan) funksiya. */
  fetchProducts: () => Promise<Product[]>
  /** Brendga xos mahsulot kartasi (har do'kon o'z dizaynini uzatadi). */
  ProductCard: ElementType
}

export function FeaturedSection({ slug, fetchProducts, ProductCard }: FeaturedSectionProps) {
