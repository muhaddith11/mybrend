...
interface ContactCtaSectionProps {
  /** Do'kon slug'i — ijtimoiy tarmoq manzillari (t.me/<slug>design) uchun. */
  slug: string
  /** Brendning UI tugmasi (barcha brendlarda bir xil dizayn-tizimi komponenti). */
  Button: ElementType
}

export function ContactCtaSection({ slug, Button }: ContactCtaSectionProps) {
  return (
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              <a
                href={`https://instagram.com/${slug}design`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2"
              >
