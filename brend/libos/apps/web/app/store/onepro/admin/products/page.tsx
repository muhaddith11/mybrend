    ...
    <div className="p-4 lg:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <Button asChild className="bg-primary text-primary-foreground hover:bg-primary/90">
          <Link href="/store/onepro/admin/products/new" className="inline-flex items-center gap-2">
          ...
          <div className="overflow-x-auto">
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          href={`/store/onepro/admin/products/${product.id}/edit`}
            ...
            {filteredProducts.length === 0 && !loading && (
              <div className="text-center py-12">
                ...
                <Link href="/store/onepro/admin/products/new" className="text-primary text-sm hover:underline mt-2 inline-block">
