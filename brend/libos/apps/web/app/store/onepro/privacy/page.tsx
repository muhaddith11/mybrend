...
const sections = [
  {
    ...
    body: "One Pro (\"biz\") sizning shaxsiy ma'lumotlaringiz maxfiyligini hurmat qiladi. Ushbu siyosat saytdan foydalanganingizda qanday ma'lumotlar yig'ilishini va ulardan qanday foydalanishimizni tushuntiradi.",
  },
  {
