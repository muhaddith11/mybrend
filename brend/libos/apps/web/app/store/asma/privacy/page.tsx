...
const sections = [
  {
    ...
    body: "Asma Design (\"biz\") sizning shaxsiy ma'lumotlaringiz maxfiyligini hurmat qiladi. Ushbu siyosat saytdan foydalanganingizda qanday ma'lumotlar yig'ilishini va ulardan qanday foydalanishimizni tushuntiradi.",
  },
  {
