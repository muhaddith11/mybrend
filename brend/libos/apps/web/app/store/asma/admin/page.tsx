...
import { formatPrice } from '@/lib/asma/store'
import { fetchOrders, Order, OrderStatus } from '@/lib/asma/orders'
...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-4 lg:p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center justify-between p-4 lg:p-6 border-b border-border">
            ...
            <Link href="/store/asma/admin/orders" className="text-sm text-primary hover:underline">
              Barchasini ko&apos;rish
            </Link>
          </div>
        ...
        >
          <div className="flex items-center justify-between p-4 lg:p-6 border-b border-border">
            ...
            <Link href="/store/asma/admin/products" className="text-sm text-primary hover:underline">
              Barchasini ko&apos;rish
            </Link>
          </div>
          <div className="divide-y divide-border">
      ...
      >
        <Link
          href="/store/asma/admin/products/new"
        ...
        <Link
          href="/store/asma/admin/lookbook"
          className="flex items-center gap-3 p-4 bg-card border border-border rounded hover:border-primary transition-colors"
        >
