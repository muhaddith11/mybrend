...
export default function ProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const tgHref = tg ? (tg.startsWith('http') ? tg : `https://t.me/${tg.replace(/^@/, '')}`) : 'https://t.me/boosner'
  ...
  if (!product) {
    return (
      <div className="min-h-screen pt-10 text-center">
        ...
        <Link href="/store/boosner/collection" className="text-primary hover:underline mt-4 inline-block">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <nav className="mb-8">
          <ol className="flex items-center gap-2 text-sm text-muted-foreground">
            <li><Link href="/store/boosner" className="hover:text-foreground transition-colors">Bosh sahifa</Link></li>
            <li>/</li>
            <li><Link href="/store/boosner/collection" className="hover:text-foreground transition-colors">Kolleksiya</Link></li>
            <li>/</li>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex gap-3">
                  <button
                    ...
                    disabled={!canAdd}
                    className="flex-1 bg-foreground text-background hover:bg-accent transition-colors h-14 text-sm font-semibold disabled:opacity-50"
                  >
                ...
                <button
                  ...
                  className="w-full bg-foreground text-background hover:bg-accent transition-colors h-14 text-sm font-semibold disabled:opacity-50"
                >
                  Xarid qilish
                </button>
                <a
                  ...
                  className="w-full bg-[#229ED9] text-white hover:bg-[#1c8dc2] transition-colors h-14 text-sm font-semibold flex items-center justify-center gap-2"
                >
        ...
        {showBuyModal && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md bg-background rounded-lg p-6 relative"
            ...
            >
              ...
              <h3 className="text-xl font-light mb-5">Xarid qilish</h3>
              ...
              <form onSubmit={submitBuy} className="space-y-4">
                <div>
                  ...
                  <input value={buyName} onChange={(e) => setBuyName(e.target.value)} placeholder="Ismingizni kiriting"
                    className="w-full h-12 px-4 border border-border rounded text-foreground outline-none focus:border-foreground" />
                </div>
                <div>
                ...
                <button type="submit" className="w-full h-12 bg-foreground text-background font-semibold hover:bg-accent transition-colors">
                  Ariza yuborish
                </button>
              </form>
            </motion.div>
