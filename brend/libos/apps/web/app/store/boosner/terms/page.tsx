...
const sections = [
  {
    ...
    body: "Boosner saytidan foydalanish orqali siz ushbu foydalanish shartlariga rozilik bildirasiz. Agar shartlarga rozi bo'lmasangiz, saytdan foydalanmang.",
  },
  {
  ...
  },
  {
    ...
    body: "Saytdagi barcha kontent — matnlar, rasmlar va logotiplar Boosner mulki hisoblanadi va ruxsatsiz foydalanish taqiqlanadi.",
  },
]
