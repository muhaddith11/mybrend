    ...
    <div className="min-h-screen pt-8 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Boosner 2024-yilda Qo&apos;qon shahrida tashkil etilgan premium erkaklar 
          ...
          >
            ...
            <div className="absolute -bottom-4 -left-4 bg-card p-6 border border-border">
              ...
              <p className="font-serif text-foreground">Boosner Team</p>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          >
            <Link href="/store/boosner/collection" className="inline-flex items-center gap-2">
